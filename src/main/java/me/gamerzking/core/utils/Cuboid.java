...
/**
 * Created by GamerzKing on 8/1/2016.
 */
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
     ...
     */
    public void fill(MaterialData materialData) {

        fill(materialData.getItemTypeId(), (byte) materialData.getData());
    }
