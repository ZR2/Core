...
public class ItemBuilder {
	...
	/**
	 * 
	 * Hides or shows all nbt tags.
	 * 
	 * @param hideNBTs Should the method hide the tags or show them.
	 * @return The item with the hidden/shown nbt tags.
	 */
	public ItemBuilder hideNBTs(boolean hideNBTs)
	{
		if (hideNBTs)
		{
